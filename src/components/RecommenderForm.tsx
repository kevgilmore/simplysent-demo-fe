...
export function RecommenderForm() {
        ...
        if (hasFullRecommendationData(savedRec.id)) {
            ...
            navigate("/products", {
                state: {
                    ...
                    genieTrainingState:
                        savedRec.genieTrainingState ||
                        fullData.genieTrainingState,
                },
            });
        } else {
            ...
            setBudgetRange([
                savedRec.formData.minBudget,
                savedRec.formData.maxBudget,
            ]);
    ...
    const handleRelationshipChange = (relationship: string) => {
        ...
        setFormData((prev) => ({
            ...
            occasion: availableOccasions.includes(prev.occasion)
                ? prev.occasion
                : "",
        }));
    };
        ...
        try {
            ...
            const newFormData = {
                ...
                relationship: context.relationship
                    ? context.relationship.charAt(0).toUpperCase() +
                      context.relationship.slice(1)
                    : "",
                occasion: context.occasion
                    ? context.occasion.charAt(0).toUpperCase() +
                      context.occasion.slice(1)
                    : "",
                sentiment: context.sentiment
                    ? context.sentiment.charAt(0).toUpperCase() +
                      context.sentiment.slice(1)
                    : "",
                interests: context.interests || [],
                favoritedrink: context.favourite_drink
                    ? context.favourite_drink.charAt(0).toUpperCase() +
                      context.favourite_drink.slice(1)
                    : "",
        ...
        try {
            if (window.fbq) {
                ...
                if (isAnySandboxMode()) {
                    ...
                    console.log(
                        "🧪 Meta Pixel Test Event: Adding test_event_code TEST44586 for sandbox mode",
                    );
                }
            ...
            if (data.products && data.products.length > 0) {
                ...
                console.log(
                    "❌ Condition not met - no products or empty array",
                );
    ...
    const validateForm = () => {
        ...
        if (
            !formData.personAge ||
            parseInt(formData.personAge) < 1 ||
            parseInt(formData.personAge) > 99
        ) {
        ...
        if (
            ...
            (formData.minBudget < 10 || formData.minBudget > 490)
        ) {
            newErrors.minBudget = "Min budget must be between £10-£490";
        }
        if (
            formData.maxBudget !== null &&
            (formData.maxBudget < 15 || formData.maxBudget > 500)
        ) {
        ...
        try {
            ...
            if (mode === "training") {
                ...
                fetch(apiUrl, {
                    ...
                    console.warn("Training submission failed (ignored):", err),
                );
                setFormData({
                    personAge: "",
                    interests: [],
        ...
        <>
            ...
            >
                        ...
                        {isAnySandboxMode() && (
                            <>
                                <motion.button
                                    ...
                                    onClick={fillFormAndSubmit}
                                    className="text-purple-600 hover:text-purple-700 font-medium flex items-center bg-purple-50 hover:bg-purple-100 px-3 py-1 rounded-lg ml-3"
                                >
                                ...
                                <motion.button
                                    ...
                                    className="text-blue-600 hover:text-blue-700 font-medium flex items-center bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-lg ml-2"
                                >
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/40">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-gradient-to-r from-purple-50/80 to-indigo-50/80 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors"
                            ...
                            {shouldShowGender(formData.relationship) && (
                                <div className="bg-gradient-to-r from-purple-50 to-indigo-50 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/40 md:col-span-3">
                                    ...
                                    <div className="flex gap-4">
                                        <label
                                            className={`flex-1 flex items-center justify-center p-3 rounded-lg cursor-pointer transition-all ${formData.gender === "male" ? "bg-purple-100 border-2 border-purple-300 shadow-sm" : "bg-white border border-gray-200 hover:bg-purple-50"}`}
                                        >
                                            <input
                                                type="radio"
                                                value="male"
                                            ...
                                            />
                                            <span
                                                className={`text-sm font-medium ${formData.gender === "male" ? "text-purple-700" : "text-gray-600"}`}
                                            >
                                                Male
                                            </span>
                                        </label>
                                        <label
                                            className={`flex-1 flex items-center justify-center p-3 rounded-lg cursor-pointer transition-all ${formData.gender === "female" ? "bg-purple-100 border-2 border-purple-300 shadow-sm" : "bg-white border border-gray-200 hover:bg-purple-50"}`}
                                        >
                                            <input
                                                type="radio"
                                                value="female"
                                            ...
                                            />
                                            <span
                                                className={`text-sm font-medium ${formData.gender === "female" ? "text-purple-700" : "text-gray-600"}`}
                                            >
                                                Female
                                            </span>
                                        </label>
                ...
                <div className="bg-gradient-to-r from-rose-50 to-red-50 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/40 relative overflow-hidden">
                    ...
                    <div className="relative">
                        <div className="flex items-center space-x-2 mb-6">
                            ...
                            <h2 className="text-xl font-semibold text-gray-800">
                                What sentiment would you like the gift to
                                convey?
                            </h2>
                        </div>
                        <div className="relative">
                                ...
                                {getSortedInterests(formData.gender).map(
                                    (interest) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <span
                                                className={`text-xs sm:text-sm font-medium text-center leading-tight break-words hyphens-auto transition-colors duration-200 ${formData.interests.includes(interest) ? "text-pink-700" : "text-gray-600 group-hover:text-gray-800"}`}
                                                style={{
                    ...
                    <div className="relative">
                        ...
                        <div className="mb-8">
                            ...
                            >
                                ...
                                <div
                                    className="absolute h-2 bg-gradient-to-r from-green-300 to-lime-300 rounded-full"
                                    style={{
                                ...
                                {/* Min handle */}
                                <div
                                    className={`absolute w-7 h-7 bg-white border-2 ${isDragging === "min" ? "border-green-500 scale-110" : "border-green-400"} rounded-full shadow-md cursor-grab ${isDragging === "min" ? "cursor-grabbing" : ""} transition-transform`}
                                    style={{
                                ...
                                {/* Max handle */}
                                <div
                                    className={`absolute w-7 h-7 bg-white border-2 ${isDragging === "max" ? "border-lime-500 scale-110" : "border-lime-400"} rounded-full shadow-md cursor-grab ${isDragging === "max" ? "cursor-grabbing" : ""} transition-transform`}
                                    style={{
                ...
                <motion.button
                    ...
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 disabled:from-purple-400 disabled:to-indigo-400 text-white font-semibold py-6 px-8 rounded-xl shadow-lg transition-all transform hover:scale-[1.02] mb-20"
                >
                    {isLoading ? (
                        <motion.div
                    ...
                    >
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm">
                                Paste your JSON data below. The context object

            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                ...
                <div className="prose max-w-none">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        us when you use our AI Gift Finder, subscribe to our
                        newsletter, or contact us.
                    </p>
                    <p className="text-gray-700 mb-4">
                        <strong>Personal Data:</strong> When using our AI Gift
                        Finder, we may ask for information about gift
                        recipients, such as their age, interests, and
                        preferences. This information is used solely to provide
                        personalized gift recommendations.
                    </p>
                    <p className="text-gray-700 mb-4">
                        <strong>Usage Data:</strong> We may also collect
                        information on how the website is accessed and used.
                        This usage data may include information such as your
                        computer's IP address, browser type, browser version,
                        the pages of our website that you visit, the time and
                    ...
                    <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-2">
                        ...
                        <li>
                            Send you emails and newsletters if you've subscribed
                        </li>
                    ...
                    <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-2">
                        <li>
                            ...
                            your information with third-party vendors, service
                            providers, and other third parties who perform
                            services on our behalf.
                        </li>
                        <li>
                            <strong>Business Transfers:</strong> If SimplySent
